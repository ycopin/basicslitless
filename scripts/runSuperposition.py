# Time-stamp: <2021-06-15 16:02:04 ycopin>
...
if __name__ == "__main__":
    ...
    parser.add_argument("config",
                        ...
                        default="./config/auxtel.ini")
    parser.add_argument("fits",
                        help="FITS file path",
                        default="./ressources/auxtel_first_light.fits")
    parser.add_argument("star", help="Star identifier", default="HD107696")
    parser.add_argument("pos",
                        help="Observed star position on the CCD (format X,Y)",
                        default="0,0")
    ...
    stars, img, config, angles, LTh, list = genSuperposition(
        args.config, args.fits, args.star, [X0, Y0])
