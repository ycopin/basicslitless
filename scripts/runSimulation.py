...
if __name__ == "__main__":
   ...
   parser.add_argument("-s", "--seeing", help="Seeing in arcsec, default seeing is 1 arcsec", default = 1, type = float)
   ...
   stars, img, angles, config, LTh, Overlap_list = genSimulation(args.config, args.star, order_list, args.seeing)
